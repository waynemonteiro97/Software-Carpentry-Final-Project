...
STEP 1 - The user needs to download the following python files from the repository into a folder and then run the main file which is Map_to_GRid.py: 
<p align="center">
   <strong> Grid_Solver_2.py, Map_to_GRid.py, Comparison_EndPts.py and Cost_Analysis.py</strong>
</p> 
<br>
